...
export const RESUME_DATA = {
  ...
  contact: {
    ...
    social: [
      {
        name: "GitHub",
        url: "https://github.com/Waqar-ahmedkhan",
        icon: GitHubIcon,
      },
      {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/waqar-ahmed-49416b237/",
        icon: LinkedInIcon,
      },
      { name: "X", url: "https://x.com/Mr___WaQAR", icon: XIcon },
      {
        name: "Medium",
        url: "https://medium.com/@waqarahmed44870",
        icon: MediumIcon,
      },
      ...
      {
        name: "YouTube",
        url: "https://www.youtube.com/@WaqarAhmed-00",
        icon: YoutubeIcon,
      },
    ],
  },
  ...
  volunteerExperience: [
    ...
    },
    {
      ...
      bulletPoints: [
        ...
        {
          text: "Demonstrated AI tools like Google’s Teachable Machine to engage students in hands-on AI exploration.",
        },
        {
          text: "Encouraged student participation in tech events and provided guidance on free AI learning resources.",
        },
      ],
    },
  ],
